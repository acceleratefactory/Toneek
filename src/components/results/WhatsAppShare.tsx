...
export default function WhatsAppShare({ score, formulaCode }: WhatsAppShareProps) {
  const text = `I just completed my skin intelligence assessment on Toneek.\nMy formula code is ${formulaCode} and my Skin OS Score is ${score}.\nFind out yours → toneek.com\n(Takes 3 minutes)`
